...
class FileUploadService:
    ...
    async def start_file_processing(self, form_data: dict, file_content: Optional[bytes]):
        """Start Celery task for file processing"""
        # Use the appropriate processor based on file_type
        # For now, using process_small_file for both, but you can add image processing later
