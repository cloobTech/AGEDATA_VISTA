...
```json
{
	...
	"data": {
		...
		"title": "K Nearest Neigbour",
		"analysis_group": "advance",
		"ai_report": "**Model Parameters Summary**\n\nThe model is configured with the following key parameters:\n\n* **Number of Neighbors**: 5 (number of closest data points to consider)\n* **Algorithm**: kd_tree (efficient algorithm for finding nearest neighbors)\n* **Weights**: distance (importance of each neighbor is based on its distance)\n* **Distance Metric**: Euclidean (measures straight-line distance between data points)\n\nThese parameters suggest that the model is using a balanced approach to find nearest neighbors, prioritizing closer data points when making predictions.",
		"id": "dfe59367-64fb-4785-91c9-012057692238",
		"created_at": "2025-05-28T08:24:34.933466Z",
		"updated_at": "2025-05-28T08:24:34.933661Z",
		"_class_": "Report"
	}
}
```